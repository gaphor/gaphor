...
\end{attrs}
\begin{entitydesc}
Basic metaclass for all items. Stereotypes are aligned according to
\rattr{s\_align} attribute.
\end{entitydesc}
\end{class}
...
\chapter{Named Items}
\section{Introduction}
Named items represent these UML classes, which derive from NamedElement.
