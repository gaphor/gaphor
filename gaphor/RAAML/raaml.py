...
class TrafficAndPeople(OperationalCondition):
    pass


class VehicleUsage(OperationalCondition):
    pass


class RoadCondition(OperationalCondition):
    pass


class Location(OperationalCondition):
    pass


class EnvironmentalCondition(OperationalCondition):
    pass
