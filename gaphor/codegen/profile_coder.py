...
def filter_uml_classes(
    classes: List[UML.Class], modeling_language: ModelingLanguage
) -> List[UML.Class]:
...
def generate(
    ...
    includes_sysml: Optional[bool] = False,
) -> None:
    ...
    uml_classes = filter_uml_classes(classes, uml_modeling_language)
    ...
    with open(outfile, "w") as f:
        ...
        if includes_sysml:
            sysml_modeling_language = SysMLModelingLanguage()
            sysml_classes = filter_uml_classes(classes, sysml_modeling_language)
