...
def test_vertex_reconnect(case):
...
def test_vertex_disconnect(case):
...
def test_initial_pseudostate_connect(case):
...
def test_initial_pseudostate_disconnect(case):
...
def test_initial_pseudostate_tail_glue(case):
...
def test_final_state_connect(case):
...
def test_final_state_head_glue(case):
