...
def test_tree_model_add_unowned_unrooted_element(tree_model, element_factory):
    element = element_factory.create(UML.Comment)

    tree_model.add_element(element)

    assert tree_model.tree_item_for_element(element) is None
