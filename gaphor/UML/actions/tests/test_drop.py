...
def test_activity_parameter_drop_with_single_activity_and_parameter(diagram, element_factory):
...
def test_activity_parameter_drop_with_multiple_activities_and_parameters(diagram, element_factory):
