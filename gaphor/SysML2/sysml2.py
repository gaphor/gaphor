...
class Expose(_Import):
    ...
    visibility: relation_many[_VisibilityKind]
...
FlowDefinition.flowEnd = derivedunion("flowEnd", Usage)
...
Usage.definition = derivedunion("definition", _Classifier)
...
ActionUsage.actionDefinition = redefine(ActionUsage, "actionDefinition", _Behavior, OccurrenceUsage.occurrenceDefinition)
...
ConstraintUsage.constraintDefinition = derivedunion("constraintDefinition", _Predicate, upper=1)
...
RequirementConstraintMembership.ownedConstraint = derivedunion("ownedConstraint", ConstraintUsage, lower=1, upper=1)
...
ActorMembership.ownedActorParameter = derivedunion("ownedActorParameter", PartUsage, lower=1, upper=1)
StakeholderMembership.ownedStakeholderParameter = derivedunion("ownedStakeholderParameter", PartUsage, lower=1, upper=1)
SubjectMembership.ownedSubjectParameter = derivedunion("ownedSubjectParameter", Usage, lower=1, upper=1)
...
CalculationUsage.calculationDefinition = redefine(CalculationUsage, "calculationDefinition", _Function, ActionUsage.actionDefinition)
...
ObjectiveMembership.ownedObjectiveRequirement = derivedunion("ownedObjectiveRequirement", RequirementUsage, lower=1, upper=1)
TransitionFeatureMembership.transitionFeature = derivedunion("transitionFeature", _Step, lower=1, upper=1)
...
StateSubactionMembership.action = derivedunion("action", ActionUsage, lower=1, upper=1)
...
VariantMembership.ownedVariantUsage = derivedunion("ownedVariantUsage", Usage, lower=1, upper=1)
...
PortConjugation.originalPortDefinition = association("originalPortDefinition", PortDefinition, lower=1, upper=1)
PortConjugation.conjugatedPortDefinition = derivedunion("conjugatedPortDefinition", ConjugatedPortDefinition, lower=1, upper=1)
PortDefinition.conjugatedPortDefinition = derivedunion("conjugatedPortDefinition", ConjugatedPortDefinition, upper=1)
ConjugatedPortDefinition.originalPortDefinition = derivedunion("originalPortDefinition", PortDefinition, lower=1, upper=1)
ConjugatedPortDefinition.ownedPortConjugator = derivedunion("ownedPortConjugator", PortConjugation, lower=1, upper=1)
ConjugatedPortTyping.portDefinition = derivedunion("portDefinition", PortDefinition, lower=1, upper=1)
ConjugatedPortTyping.conjugatedPortDefinition = association("conjugatedPortDefinition", ConjugatedPortDefinition, lower=1, upper=1)
...
Expose.visibility = association("visibility", _VisibilityKind)
...
ViewRenderingMembership.ownedRendering = derivedunion("ownedRendering", RenderingUsage, lower=1, upper=1)
...
ConnectionUsage.connectionDefinition = derivedunion("connectionDefinition", _AssociationStructure)
ItemUsage.itemDefinition.add(ConnectionUsage.connectionDefinition)  # type: ignore[attr-defined]
ConnectionDefinition.connectionEnd = derivedunion("connectionEnd", Usage)
