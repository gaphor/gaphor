...
gaphor/Safety/safety.py: models/Safety.gaphor models/Safety.override gaphor/codegen/profile_coder.py gaphor/codegen/override.py gaphor/codegen/writer.py
	poetry run gaphor/codegen/codegen.py --profile models/Safety.gaphor $@ models/Safety.override && mypy gaphor/Safety && isort $@ && black $@
