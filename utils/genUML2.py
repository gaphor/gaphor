...
class Writer:
    ...
    def write_attribute(self, a, enumerations={}):
        ...
        default = a.defaultValue and a.defaultValue.get('value')
        ...
        lower = a.lowerValue and a.lowerValue.get('value')
        if lower and lower != '0':
            params['lower'] = lower
        upper = a.upperValue and a.upperValue.get('value')
